...
/* harmony default export */ __webpack_exports__["default"] = ({
  addEvent: function addEvent(_ref, event) {
    ...
    return new _babel_runtime_core_js_promise__WEBPACK_IMPORTED_MODULE_1___default.a(function (resolve, reject) {
      _axios_js__WEBPACK_IMPORTED_MODULE_2__["default"].post('/api/apps/calendar/events/', {
        event: event
  ...
  fetchEvents: function fetchEvents(_ref2) {
    ...
    return new _babel_runtime_core_js_promise__WEBPACK_IMPORTED_MODULE_1___default.a(function (resolve, reject) {
      _axios_js__WEBPACK_IMPORTED_MODULE_2__["default"].get('/api/apps/calendar/events').then(function (response) {
  ...
  fetchEventLabels: function fetchEventLabels(_ref3) {
    ...
    return new _babel_runtime_core_js_promise__WEBPACK_IMPORTED_MODULE_1___default.a(function (resolve, reject) {
      _axios_js__WEBPACK_IMPORTED_MODULE_2__["default"].get('/api/apps/calendar/labels').then(function (response) {
  ...
  editEvent: function editEvent(_ref4, event) {
    ...
    return new _babel_runtime_core_js_promise__WEBPACK_IMPORTED_MODULE_1___default.a(function (resolve, reject) {
      _axios_js__WEBPACK_IMPORTED_MODULE_2__["default"].post("/api/apps/calendar/event/".concat(event.id), {
        event: event
      }).then(function (response) {
  ...
  removeEvent: function removeEvent(_ref5, eventId) {
    ...
    return new _babel_runtime_core_js_promise__WEBPACK_IMPORTED_MODULE_1___default.a(function (resolve, reject) {
      _axios_js__WEBPACK_IMPORTED_MODULE_2__["default"].delete("/api/apps/calendar/event/".concat(eventId)).then(function (response) {
  ...
  eventDragged: function eventDragged(_ref6, payload) {
    ...
    return new _babel_runtime_core_js_promise__WEBPACK_IMPORTED_MODULE_1___default.a(function (resolve, reject) {
      _axios_js__WEBPACK_IMPORTED_MODULE_2__["default"].post("/api/apps/calendar/event/dragged/".concat(payload.event.id), {
        payload: payload
      }).then(function (response) {
        // Convert Date String to Date Object
        var event = response.data;
