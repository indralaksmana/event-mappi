        ...
        <template slot-scope="{data}">
          <tbody>
            <vs-tr :data="tr" :key="indextr" v-for="(tr, indextr) in data">
              ...
              <vs-td>
                <p class="event-sector font-medium truncate">{{ tr.sector }}</p>
              </vs-td>
              ...
              <vs-td>
                <p class="event-price">{{ tr.date }}</p>
              </vs-td>

              <vs-td>
                <p class="event-price">{{ tr.time }}</p>
              </vs-td>

              <vs-td>
                <p class="event-price">{{ tr.place }}</p>
              </vs-td>

              <vs-td>
                <p class="event-price">{{ tr.organizer }}</p>
              </vs-td>

              <vs-td>
                <p class="event-price">{{ tr.description }}</p>
              </vs-td>
